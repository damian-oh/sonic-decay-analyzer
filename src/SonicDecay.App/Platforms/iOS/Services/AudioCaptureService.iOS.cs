...
{
    /// <summary>
    /// iOS-specific audio capture implementation using AVAudioEngine.
    /// </summary>
    public partial class AudioCaptureService
    {
        ...
        {
            // AVAudioEngine is available on iOS 8+ (we target iOS 15+)
            return true;
        }
        ...
        private void HandleAudioBuffer(AVAudioPcmBuffer buffer)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    ...
                    // First channel (mono or left channel of stereo)
